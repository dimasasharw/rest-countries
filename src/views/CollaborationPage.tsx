    ...
    <div className="flex items-center justify-center w-full h-full">
      <div className="flex flex-wrap w-[95%] h-[85vh] bg-[#E7E5E4] overflow-y-auto rounded-lg p-2 shadow-xl">
        <div className="flex flex-wrap w-full overflow-y-auto scrollbar-hide rounded-lg bg-stone-300">
          <TableContainer component={Paper} className="flex flex-col justify-start items-center rounded-lg shadow-md p-5 h-[44.3rem] overflow-y-auto scrollbar-hide">
            <h1 className="flex font-semibold text-2xl my-4">Country Collaborators</h1>
            {collaboratedCountries?.length > 0 ? (
              <Table className="flex justify-center items-center max-w-[40rem]">
                <TableHead>
                  <TableRow>
                    <TableCell align="center" className="font-semibold text-center">Country Name</TableCell>
                ...
                <TableBody className="flex h-full overflow-y-auto scrollbar-hide">
                  {collaboratedCountries.map((collaborator: any, i: number) => (
                    <TableRow key={i}>
                      <TableCell align="center">{collaborator?.name?.common}</TableCell>
                      <TableCell align="center">
                        <Button
                          ...
                          size="small"
                          className="ml-2"
                          onClick={() => dispatch(removeCollaborator(collaborator?.name?.common))}
                        >
                          Remove
                        </Button>
                      </TableCell>
              ...
              <div className="flex h-full justify-center items-center">
                <div className="flex flex-col px-3 justify-center items-center text-center h-[8rem] min-w-[15rem] border text-wrap rounded-2xl">
                  <h2 className="flex text-base my-4">No country collaboration at this time.</h2>
                  <Button
                    variant="outlined"
                    color="secondary"
                    size="small"
