...
const HomePage = () => {
  ...
  const filterAbjad = (abj: string) => {
    ...
    const filteredCountries = countries?.filter(
      (country: any) => country?.name?.common[0] === abj
    );
    setArrayCountries(filteredCountries);
  };
  // const filterAsc = () => {
  //   const filtera = arrayCountries?.sort(
  ...
  // };
  // const filterDesc = () => {
  //   const filterd = arrayCountries?.sort(
  //     (a: any, b: any) => b.name?.common - a.name?.common
  //   );
      ...
      <div className="flex flex-col w-full h-full text-[2rem] overflow-y-scroll scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
        <div className="flex flex-col w-full px-[2rem] justify-center items-center self-stretch">
          <h1
            ...
            className="flex justify-center items-center text-4xl font-bold text-center my-5"
          >
            List of Countries
          </h1>
          ...
          <div>
            ...
            <div className="flex justify-center items-center">
              <Button
                variant="outlined"
                onClick={() => setArrayCountries(countries)}
              >
                Reset
              </Button>
            </div>
            ...
            {arrayCountries &&
              ...
              arrayCountries?.map((country: any, index: number) => (
                <div
                  ...
                  onClick={() =>
                    navigate(`/${country?.name?.common}/${country?.cca2}`)
                  }
                >
